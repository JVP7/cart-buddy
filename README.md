...
Cart Buddy is live on the [Chrome Web Store](https://chromewebstore.google.com/detail/cart-buddy/acjbceklngadegjljndkppjgcgimehag). But, if running it locally is preferred you can: 
